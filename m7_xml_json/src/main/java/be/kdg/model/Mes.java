...
import be.kdg.parsing.LemmetAdapter;
 ...
 * 18/09/2023
 */
@XmlType(propOrder = { "type", "materiaal", "hardheid", "lemmet", "lengte", "productieDag"})
public class Mes implements Comparable<Mes> {
    private String type;
    @SerializedName("productiedag")
    ...
    @XmlJavaTypeAdapter(LemmetAdapter.class)
