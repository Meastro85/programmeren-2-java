 ...
 * 18/09/2023
 */
public class Messen implements Serializable {
    @Serial
    ...
    public boolean equals(Object o) {
        ...
        for(int i = 0; i < messen.getSize(); i++){
            Mes mes = (Mes)messen.messenTreeSet.toArray()[i];
            Mes eigenMes = (Mes)this.messenTreeSet.toArray()[i];
            if (!(mes.getType().equals(eigenMes.getType()) && mes.getMateriaal().equals(eigenMes.getMateriaal()) && mes.getLemmet() == eigenMes.getLemmet())) {
                return false;
            }
        }
    ...
    @Override
    public int hashCode() {
        return messenTreeSet != null ? messenTreeSet.hashCode() : 0;
    }
